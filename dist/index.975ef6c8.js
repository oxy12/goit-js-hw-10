...
var _catsApi = require("./js/cats-api");
...
(0, _catsApi.fetchBreeds)().then((r)=>{
    const markupOption = r.map((cat)=>{
        return `<option value="${cat.id}">${cat.name}</option>\n`;
    }).join("");
    select.insertAdjacentHTML("beforeend", markupOption);
}).catch((error)=>{
    (0, _notiflixDefault.default).Notify.failure(`Error fetch API, ${error}`);
});
function selectCat(e) {
    catInfo.innerHTML = "";
    const loader1 = '<span class="loader"></span>';
    catInfo.insertAdjacentHTML("beforeend", loader1);
    const catId = e.target.value;
    (0, _catsApi.fetchCatByBreed)(catId).then((cat)=>{
        catInfo.innerHTML = "";
...
},{"notiflix":"5z0Oc","./js/cats-api":"exI3r","slim-select":"lzHUr","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5z0Oc":[function(require,module,exports) {
var global = arguments[3];
...
},{}],"exI3r":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fetchBreeds", ()=>fetchBreeds);
parcelHelpers.export(exports, "fetchCatByBreed", ()=>fetchCatByBreed);
const API_KEY = "live_XYApthMjZmH4OTeiNHIyqqRlAgDJULwU8IWTO74wnJTYK7ptcRusAsKbG7bBtvcF";
...
async function fetchCatByBreed(catId) {
    const response = await fetch(`${catImageUrl}/search?breed_ids=${catId}&api_key=${API_KEY}`);
